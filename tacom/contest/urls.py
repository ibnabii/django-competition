...
urlpatterns = [
    ...
    path('payment/<uuid:payment_id>/paypal/', views.PayPalDispatchView.as_view(), name='payment_paypal'),
    path('payment/paypal/success/<uuid:payment_id>/', views.PayPalSuccessRedirectView.as_view(), name='payment_paypal_success'),
    path('payment/paypal/failure/<uuid:payment_id>/', views.PayPalFailureRedirectView.as_view(), name='payment_paypal_failure'),
