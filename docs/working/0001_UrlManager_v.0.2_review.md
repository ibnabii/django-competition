...
> **[COMMENT]**: Django often may return 500 with unexpeted POST body, hence DataProvideer should be informed about methods needed, and provide data
...
> **[COMMENT]**: Just copy the approach from my list_urls command
> 
